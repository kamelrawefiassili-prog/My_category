...
keys: ["stickers", "sticker", "ستيكر", "ستيكرات"]
  ...
  { 
    ...
    subGroups: [
      ...
      { id: "reels_views", label: "مشاهدات فيديو ريلز", keys: ["reels views","مشاهدة ريلز","مشاهدات ريلز","reels","ريلز","Reels"] },
...
{     
  ...
  keys: ["instagram ads", "اعلانات انستقرام", "اعلانات انتسقرام", "تمويل انستقرام","متابعين انستقرام"],    
  subGroups: [    
    { id: "ads_followers", label: "متابعين عبر الاعلانات", keys: ["followers", "متابعين", "متابع","حسابات عربية حقيقة"] },
    { id: "ads_likes", label: "لايكات عبر الاعلانات", keys: ["likes", "لايكات", "لايك"] },
    { id: "ads_views", label: "مشاهدات عبر الاعلانات", keys: ["views", "مشاهدات", "مشاهدة"] }
  ]    
},
{     
  ...
  keys: ["tiktok ads", "اعلانات تيك توك", "تمويل تيك توك","متابعين تيك توك"],    
  subGroups: [    
    { id: "ads_followers", label: "متابعين عبر الاعلانات", keys: ["followers", "متابعين", "متابع","عن طريق الاعلانات"] },
    { id: "ads_likes", label: "لايكات عبر الاعلانات", keys: ["likes", "لايكات", "لايك"] },
    { id: "ads_views", label: "مشاهدات عبر الاعلانات", keys: ["views", "مشاهدات", "مشاهدة"] }
  ]    
}
